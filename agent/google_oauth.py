...
#
# Resolution order:
#   1. DAG_GEMINI_CLIENT_ID / DAG_GEMINI_CLIENT_SECRET env vars (power users)
...
ENV_CLIENT_ID = "DAG_GEMINI_CLIENT_ID"
ENV_CLIENT_SECRET = "DAG_GEMINI_CLIENT_SECRET"
...
_HEADLESS_ENV_VARS = ("SSH_CONNECTION", "SSH_CLIENT", "SSH_TTY", "DAG_HEADLESS")
...
def _require_client_id() -> str:
    ...
    if not cid:
        raise GoogleOAuthError(
            ...
            "  2. Set DAG_GEMINI_CLIENT_ID and DAG_GEMINI_CLIENT_SECRET in ~/.dag/.env\n"
            "\n"
