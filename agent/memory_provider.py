...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - deepsuck_home (str): The active DEEPSUCK_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.deepsuck``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "deepsuck").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'deepsuck memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], deepsuck_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'deepsuck memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``deepsuck_home`` is the active DEEPSUCK_HOME directory path.
