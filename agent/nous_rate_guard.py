...
(3 SDK retries x 3 Deepsuck retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_deepsuck_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".deepsuck")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Deepsuck, ...) behind one endpoint.  A 429 can mean either:
