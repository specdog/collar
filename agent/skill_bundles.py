...
Storage
-------
Bundles live in ``~/.dag/skill-bundles/*.yaml`` (and the equivalent
profile-aware directory under ``DAG_HOME``). Each file looks like::
...
- :func:`list_bundles` — return rich info for display (``dag bundles``)
...
# ---------------------------------------------------------------------------
# File-level CRUD helpers — used by `dag bundles` CLI subcommand.
# ---------------------------------------------------------------------------
