...
(``dag``, ``dag-agent``, ``dag-acp``, ``python -m gateway.run``,
...
# Apply on import — entry points just need ``import dag_bootstrap``
# (or ``from dag_bootstrap import apply_windows_utf8_bootstrap``) at
