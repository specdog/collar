...
DAG_OVERLAYS: Dict[str, DagOverlay] = {
    ...
    "qwen-oauth": DagOverlay(
        ...
        base_url_env_var="DAG_QWEN_BASE_URL",
    ),
...
def get_provider(name: str) -> Optional[ProviderDef]:
    ...
    overlay = DAG_OVERLAYS.get(canonical)
...
def determine_api_mode(provider: str, base_url: str = "") -> str:
    ...
    # Direct provider checks for providers not in DAG_OVERLAYS
    if provider == "bedrock":
