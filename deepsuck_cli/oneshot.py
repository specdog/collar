...
def run_oneshot(
    ...
    Args:
        ...
        model: Optional model override. Falls back to DEEPSUCK_INFERENCE_MODEL
...
def _run_agent(
    ...
    env_model = os.getenv("DEEPSUCK_INFERENCE_MODEL", "").strip()
    ...
    if effective_provider is None and (model or env_model):
        ...
        if explicit_model:
            ...
            if direct is not None:
                ...
                current_provider = (
                    cfg_provider
                    or os.getenv("DEEPSUCK_INFERENCE_PROVIDER", "").strip().lower()
                    or "auto"
                )
