...
def _apply_default_agent_settings(config: dict):
    ...
    # bridges it into DEEPSUCK_MAX_ITERATIONS at startup. We no longer write
    ...
    remove_env_value("DEEPSUCK_MAX_ITERATIONS")
...
def setup_agent_settings(config: dict):
    ...
    try:
        ...
        if max_iter > 0:
            ...
            # DEEPSUCK_MAX_ITERATIONS from agent.max_turns at startup.
