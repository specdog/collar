...
# ---------------------------------------------------------------------------
try:
    from dag_cli import __version__ as _COLLAR_VERSION
except ImportError:
    _COLLAR_VERSION = "0.0.0"

_APP_VERSION = _COLLAR_VERSION
_BOT_VERSION = _COLLAR_VERSION
_YUANBAO_INSTANCE_ID = str(COLLAR_INSTANCE_ID)  # single source: yuanbao_proto.COLLAR_INSTANCE_ID
